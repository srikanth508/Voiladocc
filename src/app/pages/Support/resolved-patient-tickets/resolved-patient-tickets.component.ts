...
@Component({
  selector: 'app-resolved-patient-tickets',
  templateUrl: './resolved-patient-tickets.component.html',
  styleUrls: ['./resolved-patient-tickets.component.css']
})
export class ResolvedPatientTicketsComponent implements OnInit {
