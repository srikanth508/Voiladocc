...
export class EditPharmacyRegComponent implements OnInit {
  ...
  public getlanguage() {
    this.docservice
      .GetAdmin_PharmacyRegistration_LabelByLanguageID(this.languageid)
      .subscribe(
        (data) => {
          this.labels = data;
        },
  ...
  public getpharmacydetailsforadmin() {
    this.docservice
      .GetPhamacyDetailsForAdminByLanguageID(this.id, this.languageid)
      .subscribe(
        (data) => {
          this.details = data[0];
  ...
  public GetPharmacyRevenue() {
    this.docservice
      .GetPharmacySubscriptions_Revenue(this.id)
      .subscribe((data) => {
  ...
  public UpdatePharmacyrevenue() {
    ...
    this.docservice
      .UpdatePharmacySubscriptions_Revenue(entity)
      .subscribe((data) => {
        if (this.languageid == 1) {
          Swal.fire("Updated Successfully");
          this.GetPharmacyRevenue();
  ...
  public InsertPharmacyRevenue() {
    ...
    this.docservice
      .InsertPharmacySubscriptions_Revenue(entity)
      .subscribe((data) => {
        if (data != 0) {
          if (this.languageid == 1) {
