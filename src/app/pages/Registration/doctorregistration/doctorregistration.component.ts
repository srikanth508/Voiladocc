...
export class DoctorregistrationComponent implements OnInit {
  ...
  public insertdoctorregistration() {
    ...
    if (this.countryid == undefined || this.countryid.length == 0) {
      ...
      this.spinner.show();
      if (
        (this.contractstartdate = undefined || this.contractstartdate == null)
      ) {
  ...
  public insertdoctormedicalregistration() {
    ...
    this.docservice
      .InsertDoctorMedicalRegistration(entity)
      .subscribe((data) => {
        if (data != 0) {
        }
      });
  ...
  public insertidentityProof() {
    if (this.attachmentsurl.length == 0) {
      this.attachmentsurl[0] = "F:MarocAPIImagesDocIdentityProofWrong_128.png";
    }
  ...
  public DoctorSignatureUpload() {
    this.docservice
      .DoctorSignatureUpload(this.signatureattachmentssss)
      .subscribe((res) => {
